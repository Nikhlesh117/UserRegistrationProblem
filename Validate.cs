...
namespace UserRegistration
{
    public class Validate
    {
        ...
        public bool FirstName(string firstName) => (Regex.IsMatch(firstName, Regex_FirstName));
        public bool LastName(string LastName) => (Regex.IsMatch(LastName, Regex_LastName));
        public bool Email(string email) => (Regex.IsMatch(email, Regex_Email));
        public bool Mobile(string PhoneNumber) => (Regex.IsMatch(PhoneNumber, Regex_PhoneNumber));
        public bool PasswordR1(string password) => (Regex.IsMatch(password, Regex_PasswordR1));
        public bool PasswordR2(string password) => (Regex.IsMatch(password, Regex_PasswordR2));
        public bool PasswordR3(string password) => (Regex.IsMatch(password, Regex_PasswordR3));
        public bool PasswordR4(string password) => (Regex.IsMatch(password, Regex_PasswordR4));
        ...
        public string Emails(string email)
        {
