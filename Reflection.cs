    ...
    public class Reflection
    {
        public object CreateUserRegistration(string className, string constructorName)
        {
            ...
            if (result.Success)
            {
                ...
                {
                    throw new ValidateException(ValidateException.ExceptionType.NO_SUCH_CLASS, "Class not found");
                }
            }
            else
            {
                throw new ValidateException(ValidateException.ExceptionType.NO_SUCH_METHOD, "Constructor not found");
            }
        }
